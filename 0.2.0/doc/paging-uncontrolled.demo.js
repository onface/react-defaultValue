...
/******/ 	__webpack_require__.p = "/react-defaultvalue/0.2.0";
/******/
...
Paging = __webpack_require__("./lib/index.js")(Paging, {
...
/***/ "./doc/paging-uncontrolled.demo.js":
/***/ (function(module, exports, __webpack_require__) {
...
var Paging = __webpack_require__("./doc/Paging.js");

var UncontrolledPaging = function (_React$Component) {
    _inherits(UncontrolledPaging, _React$Component);

    function UncontrolledPaging() {
        _classCallCheck(this, UncontrolledPaging);

        return _possibleConstructorReturn(this, (UncontrolledPaging.__proto__ || Object.getPrototypeOf(UncontrolledPaging)).apply(this, arguments));
    }

    _createClass(UncontrolledPaging, [{
        key: 'render',
        value: function render() {
            var self = this;
            return __webpack_require__("./node_modules/react/index.js").createElement(Paging, { defaultPage: 2, defaultPageSize: 50 });
        }
    }]);

    return UncontrolledPaging;
}(React.Component);
/*ONFACE-DEL*/

UncontrolledPaging = __webpack_require__("./node_modules/react-hot-loader/index.js").hot(module)(UncontrolledPaging);
ReactDOM.render(__webpack_require__("./node_modules/react/index.js").createElement(UncontrolledPaging, null), document.getElementById('paging-uncontrolled-demo'));
...
var _util = __webpack_require__("./lib/util.js");
...
var reactDefaultValue = function reactDefaultValue(WrappedComponent, settings) {
    settings = (0, _safeExtend2.default)(true, _defaultSettings2.default, settings);
    // input unifrom array
    ...
    var ReactDefaultValue = function (_Component) {
        _inherits(ReactDefaultValue, _Component);

        function ReactDefaultValue(props) {
            _classCallCheck(this, ReactDefaultValue);

            var _this = _possibleConstructorReturn(this, (ReactDefaultValue.__proto__ || Object.getPrototypeOf(ReactDefaultValue)).call(this, props));

            _this.transInput = function () {
                var self = _this;
            };
            ...
            settings.input.forEach(function (key) {
                var name = _util2.default.getInputName(key);
                self.inputDefaultKey.push("default" + _util2.default.firstUpperCase(name));
            });
            self.state = {};
            var inputIndex = 0;
            self.inputDefaultKey.forEach(function (key, index) {
                var value = props[key];
                var inputDefaultValue = void 0;
                if (_typeof(settings.input[index]) === 'object') {
        ...
        _createClass(ReactDefaultValue, [{
            key: "render",
            value: function render() {
                var self = this;
                var proxyProps = {};
                var isControlled = settings.input.some(function (key) {
                        ...
                        switch (typeof item === "undefined" ? "undefined" : _typeof(item)) {
                            case 'string':
                                ...
                                sync = function sync() {
                                    ...
                                    _util2.default.defaultSync(arg, function (data) {
                                        self.setState(_defineProperty({}, self.inputDefaultKey[index], data));
                                    });
                                };
                                break;
                            case 'object':
                                ...
                                sync = function sync() {
                                    ...
                                    self.setState(_defineProperty({}, self.inputDefaultKey[index], item.sync.apply({}, arg)));
                                };
                                break;
                            default:
                                var typeErrorMessage = 'react-defaultvalue(npm): ' + 'reactDefaultValue(App, settings) settings.output[item]' + ' item must be string or object';
                                throw new Error(typeErrorMessage);
                        }
                        proxyProps[key] = sync;
                    });
                }
                var forwardedRef = self.props.forwardedRef;

                return __webpack_require__("./node_modules/react/index.js").createElement(WrappedComponent, _extends({
                    ref: forwardedRef
                }, self.props, proxyProps));
            }
        }]);
    ...
    if (typeof _react2.default.forwardRef === 'undefined') {
        ...
        return _react2.default.forwardRef(function (props, ref) {
            return __webpack_require__("./node_modules/react/index.js").createElement(ReactDefaultValue, _extends({}, props, { forwardedRef: ref }));
        });
    }
};
...
module.exports = {
    firstUpperCase: function firstUpperCase(str) {
        var output = str.trim().split('');
        output[0] = output[0].toUpperCase();
        output = output.join('');
        return output;
    },
    getInputName: function getInputName(input) {
        var name = void 0;
    ...
    defaultSync: function defaultSync(arg, callback) {
        var event = arg[0];
        var isEvent = typeof event.target !== 'undefined' && typeof event.target.setAttribute === 'function';
        if (isEvent) {
...
module.exports = __webpack_require__("./doc/paging-uncontrolled.demo.js");
