...
var ControlledMenu = function (_React$Component) {
    _inherits(ControlledMenu, _React$Component);

    function ControlledMenu(props) {
        _classCallCheck(this, ControlledMenu);

        var _this = _possibleConstructorReturn(this, (ControlledMenu.__proto__ || Object.getPrototypeOf(ControlledMenu)).call(this, props));
    ...
    _createClass(ControlledMenu, [{
        key: 'render',
        value: function render() {
            var self = this;
            return __webpack_require__("./node_modules/react/index.js").createElement(Menu, {
...
ControlledMenu = __webpack_require__("./node_modules/react-hot-loader/index.js").hot(module)(ControlledMenu);
ReactDOM.render(__webpack_require__("./node_modules/react/index.js").createElement(ControlledMenu, null), document.getElementById('menu-controlled-demo'));
...
module.exports = __webpack_require__("./doc/menu-controlled.demo.js");
