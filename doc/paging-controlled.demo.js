...
var ControlledPaging = function (_React$Component) {
    _inherits(ControlledPaging, _React$Component);

    function ControlledPaging(props) {
        _classCallCheck(this, ControlledPaging);

        var _this = _possibleConstructorReturn(this, (ControlledPaging.__proto__ || Object.getPrototypeOf(ControlledPaging)).call(this, props));
    ...
    _createClass(ControlledPaging, [{
        key: 'render',
        value: function render() {
            var self = this;
            return __webpack_require__("./node_modules/react/index.js").createElement(Paging, {
    ...
    return ControlledPaging;
}(React.Component);
/*ONFACE-DEL*/

ControlledPaging = __webpack_require__("./node_modules/react-hot-loader/index.js").hot(module)(ControlledPaging);
ReactDOM.render(__webpack_require__("./node_modules/react/index.js").createElement(ControlledPaging, null), document.getElementById('paging-controlled-demo'));
...
module.exports = __webpack_require__("./doc/paging-controlled.demo.js");
