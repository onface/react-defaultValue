...
Menu.defaultProps = {
    ...
    // 一行代码实现 defaultValue
};Menu = __webpack_require__("./lib/index.js")(Menu, { output: 'onPick' });
module.exports = Menu;

/***/ }),

/***/ "./doc/menu-uncontrolled.demo.js":
/***/ (function(module, exports, __webpack_require__) {
...
var Menu = __webpack_require__("./doc/Menu.js");

var UncontrolledMenu = function (_React$Component) {
    _inherits(UncontrolledMenu, _React$Component);

    function UncontrolledMenu() {
        _classCallCheck(this, UncontrolledMenu);

        return _possibleConstructorReturn(this, (UncontrolledMenu.__proto__ || Object.getPrototypeOf(UncontrolledMenu)).apply(this, arguments));
    }

    _createClass(UncontrolledMenu, [{
        key: 'render',
        value: function render() {
            var self = this;
            return __webpack_require__("./node_modules/react/index.js").createElement(Menu, { defaultValue: 'egg' });
        }
    }]);

    return UncontrolledMenu;
}(React.Component);
/*ONFACE-DEL*/

UncontrolledMenu = __webpack_require__("./node_modules/react-hot-loader/index.js").hot(module)(UncontrolledMenu);
ReactDOM.render(__webpack_require__("./node_modules/react/index.js").createElement(UncontrolledMenu, null), document.getElementById('menu-uncontrolled-demo'));
...
module.exports = __webpack_require__("./doc/menu-uncontrolled.demo.js");
