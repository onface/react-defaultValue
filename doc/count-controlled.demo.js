...
var ControlledCount = function (_React$Component) {
    _inherits(ControlledCount, _React$Component);

    function ControlledCount(props) {
        _classCallCheck(this, ControlledCount);

        var _this = _possibleConstructorReturn(this, (ControlledCount.__proto__ || Object.getPrototypeOf(ControlledCount)).call(this, props));

        _this.state = { value: 10 };
        return _this;
    }

    _createClass(ControlledCount, [{
        key: 'render',
        value: function render() {
            var self = this;
            return __webpack_require__("./node_modules/react/index.js").createElement(Count, {
...
ControlledCount = __webpack_require__("./node_modules/react-hot-loader/index.js").hot(module)(ControlledCount);
ReactDOM.render(__webpack_require__("./node_modules/react/index.js").createElement(ControlledCount, null), document.getElementById('count-controlled-demo'));
...
module.exports = __webpack_require__("./doc/count-controlled.demo.js");
